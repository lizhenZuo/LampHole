...
static inline CGFloat const SVPullToRefreshViewHeight(){
    if ([DDUtilities isDeviceIphoneXSeries]) {
        return 80;
    }
    return 60;
}
static inline CGFloat const SVPullToRefreshViewWidth(){
    if ([DDUtilities isDeviceIphoneXSeries]) {
        return 80;
    }
    return 60;
}
#define SVPullToRefreshViewHeight SVPullToRefreshViewHeight()
#define SVPullToRefreshViewWidth SVPullToRefreshViewWidth()
