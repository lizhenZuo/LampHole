...
//  AiTeacheriPhone
//
//  Created by dingdong on 2019/4/4.
//  Copyright © 2019年 ddkt365. All rights reserved.
//

#ifndef DDVersion_Pre_h
#define DDVersion_Pre_h

/** 客户端版本号  注意：上线时必须修改为最新版本号 */
static NSString *const kAppReleaseVersionBuilder = @"2.1.4";
...
static NSString *const kLbsSocketServerHost = @"lbspre.ddkt365.com";
