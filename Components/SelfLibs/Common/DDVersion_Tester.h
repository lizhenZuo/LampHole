...
/**  测试版本，外网环境 */
#ifndef DDVersion_Tester_h
#define DDVersion_Tester_h
...
static NSString *const kLbsSocketServerHost = @"lbstest.ddkt365.com";//@"1 92.168.0.108" //小泉测试专用
